...
.get_prj_shared_path <- function() {
  ...
  if (!(fs::is_dir(Sys.getenv("PRJ_SHARED_PATH")))) {
    usethis::ui_stop("
      Environmental variable {usethis::ui_field('PRJ_SHARED_PATH')} is set to {usethis::ui_value(Sys.getenv('PRJ_SHARED_PATH'))}.
  ...
  usethis::ui_done("
   {usethis::ui_field('PRJ_SHARED_PATH')} set to {usethis::ui_value(Sys.getenv('PRJ_SHARED_PATH'))}
  ")
